                                        ...
                                        <tbody>
                                            {users.map((user, index) => (
                                                <tr key={user.id}>
                                                    ...
                                                    <td className='text-left'>
                                                        <p className="text-sm font-weight-bold mb-0">{user.address}</p>
                                                    </td>
                                                    <td className='text-left'>
                                                        <span className="text-xs font-weight-bold">{user.bio}</span>
                                                    </td>
                                                    <td className='text-left'>
                                                        <span className="text-xs font-weight-bold">{user.personal_url}</span>
                                                    </td>
                                                    <td className="align-middle text-left">
                                                        <div className="d-flex align-items-center text-left">
                                                            <span className="text-xs font-weight-bold mb-0">{user.is_active ===1? "Yes" : "No" }</span>
                                                        </div>
                                                    </td>
