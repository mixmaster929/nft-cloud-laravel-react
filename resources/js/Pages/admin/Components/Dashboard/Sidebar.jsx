        ...
        <aside className="sidenav bg-default navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
            ...
            <div className="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                        <Link className={`${route().current('categories.*') && 'active'} nav-link`} href={route('categories.index')}>
                            <div className="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <li className="nav-item">
                        <Link className={`${route().current('fees.*') && 'active'} nav-link`} href={route('fees.index')}>
                            <div className="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
